...
module.exports = async function vendaFlow(telefone, msg, state) {
  ...
  switch (state.etapa) {
    case "venda_tipo":
      ...
      await updateSession(telefone, { etapa: "venda_local", dados: state.dados });
      return sendText(telefone, "Qual *bairro/região* do imóvel?");

    case "venda_local":
      state.dados.local = msg;
      await updateSession(telefone, { etapa: "venda_tamanho", dados: state.dados });
      return sendText(
        telefone,
    ...
    case "venda_tamanho":
      ...
      await updateSession(telefone, { etapa: "venda_estado", dados: state.dados });
      return sendText(
        telefone,
    ...
    case "venda_estado":
      ...
      await updateSession(telefone, { etapa: "venda_valor", dados: state.dados });
