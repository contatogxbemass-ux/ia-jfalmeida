...
const { enviarMensagemWhatsApp } = require("./zapi");
...
app.post("/webhook", async (req, res) => {
  ...
  // 🚨 BLOQUEIO ABSOLUTO CONTRA GRUPOS (ENTRADA)
  if (raw.isGroup === true) {
  ...
  // ===============================================
  // FLUXOS (COMPRA, VENDA, ALUGUEL, LISTAGEM, FINANCIAMENTO)
  // ===============================================
